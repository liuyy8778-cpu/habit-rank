...
const LIB = [
  ...
  { id:'sc5', type:'task',  dom:'螢幕自律', domColor:'indigo',  where:'home',     label:'用完手機主動放回充電座', sub:'用完隨手放回充電座，幫下一次的自己少一個分心的入口。放回去，是你替專注先鋪好路。',        coin:5, xp:4, unlockRank:3, icon:'i-shield' },
  { id:'sc6', type:'task',  dom:'螢幕自律', domColor:'indigo',  where:'anywhere', label:'吃飯時不看螢幕',        sub:'吃飯時把螢幕收起來，這頓飯的味道和聊天都會回到你身上。專心吃，是你留給自己和家人的一段完整時間。',     coin:5, xp:4, unlockRank:3, icon:'i-heart' },
  { id:'sl1', type:'habit', dom:'作息自律', domColor:'sky',     where:'anywhere', times:{home:'22:45',school:'22:00'}, label:'準時上床睡覺',        desc:'到睡覺時間就上床，等於提早幫明天的自己充好電。愈固定，身體愈記得住入睡的節奏，睡得沉、醒得清爽。',              coin:15, xp:12, honestyEligible:true, unlockRank:2, icon:'i-moon' },
  { id:'sl2', type:'task',  dom:'作息自律', domColor:'sky',     where:'anywhere', label:'鬧鐘響第一次就起床',    sub:'鬧鐘第一次響就起身，這一天就從「我說起就起」開始。省下的賴床時間，是你多賺到的清醒早晨。',   coin:10, xp:8, unlockRank:1, icon:'i-hour' },
  { id:'sl3', type:'task',  dom:'作息自律', domColor:'sky',     where:'home',     label:'睡前準備好明天的東西',  sub:'睡前先把書包、衣服備好，等於先幫明天的自己排除路障。備好了，早上就從容出門，不慌不忙。',   coin:5, xp:4, unlockRank:3, icon:'i-brief' },
  { id:'ld1', type:'task',  dom:'學習自律', domColor:'teal',    where:'home',     label:'回家先寫完作業再玩',    sub:'回家先把作業解決掉，剩下的時間就真的是你的、玩得心安理得。先苦後甜，是你替自己安排的順序。',             coin:10, xp:8, unlockRank:0, icon:'i-brief' },
  { id:'ld2', type:'task',  dom:'學習自律', domColor:'teal',    where:'home',     label:'專注讀書 30 分',        sub:'給自己 30 分鐘不被打斷的專注，把讀進去的變成真的記得住。專注愈完整，同樣的時間你學得愈多。',       coin:10, xp:8, unlockRank:2, icon:'i-chart' },
  { id:'ld3', type:'task',  dom:'學習自律', domColor:'teal',    where:'anywhere', label:'主動多做一點',          sub:'預習或複習多做一點，是替未來的自己先存實力。多練的每一點，考的時候都更拿得住。',         coin:6, xp:5, unlockRank:3, icon:'i-spark' },
  { id:'bd1', type:'task',  dom:'身體自律', domColor:'amber',   where:'anywhere', label:'離線運動 30 分',        sub:'離線動一動，把身體重新充飽電。動完的你，腦袋更清楚、更有力氣。', coin:8, xp:6, unlockRank:0, icon:'i-bolt' },
  { id:'bd2', type:'task',  dom:'身體自律', domColor:'amber',   where:'anywhere', label:'喝足夠的水',            sub:'一天把水喝夠，幫腦袋和身體隨時保持在線。喝滿，你會發現自己更清醒、更不容易累。',         coin:4, xp:3, unlockRank:3, icon:'i-target' },
  { id:'bd3', type:'task',  dom:'身體自律', domColor:'amber',   where:'anywhere', label:'好好吃完正餐',          sub:'好好把正餐吃完，是替一整天的體力先加滿油。吃得夠，你才有力氣去做想做的事。',             coin:4, xp:3, unlockRank:2, icon:'i-heart' },
  { id:'rp1', type:'task',  dom:'責任自律', domColor:'teal',    where:'home',     label:'完成一件家事',          sub:'主動做一件家事，這個家就有一份是你顧的。出一份力，你也是撐起這個家的人，不只是被照顧的人。',           coin:8, xp:6, unlockRank:1, icon:'i-check' },
